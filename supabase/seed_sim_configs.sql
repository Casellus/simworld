...
VALUES (uid, acc, 'simulatore', 'ffb', 'Configurazione Thrustmaster T300 / T248', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, acc, 'simulatore', 'ffb', 'Configurazione Fanatec CSL DD / DD Pro', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, acc, 'simulatore', 'grafica', 'Grafica Stabile 1080p 60fps', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, ira, 'simulatore', 'ffb', 'Configurazione Direct Drive (Fanatec / Simucube / Moza)', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, ira, 'simulatore', 'ffb', 'Configurazione Logitech G29 / G923', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, ira, 'simulatore', 'grafica', 'Grafica Competitivo – Max FPS', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, lmu, 'simulatore', 'ffb', 'Configurazione Thrustmaster & Fanatec', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, ac, 'simulatore', 'ffb', 'Configurazione Content Manager + LUT', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, ac, 'simulatore', 'controlli', 'Mapping Sterzo & Pedali', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, f125, 'simulatore', 'ffb', 'Configurazione Volante F1 25', '', '',
...
INSERT INTO setups (user_id, game_id, setup_type, category, title, car, track, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, acc, 'simulatore', 'audio', 'Audio Ottimizzato per Cuffie', '', '',
