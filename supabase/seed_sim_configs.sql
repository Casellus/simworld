...
INSERT INTO setups (user_id, game_id, setup_type, category, title, notes, photo_url, downloads, rating_sum, rating_count)
VALUES (uid, acc, 'simulatore', 'ffb',
  'ACC – FFB Thrustmaster T300 / T248',
...
VALUES (uid, acc, 'simulatore', 'grafica',
  'ACC – Grafica 1080p 60fps Stabile (GPU mid-range)',
...
VALUES (uid, ira, 'simulatore', 'ffb',
  'iRacing – FFB Direct Drive (Fanatec / Simucube / Moza)',
...
VALUES (uid, ira, 'simulatore', 'grafica',
  'iRacing – Grafica Competitivo (massimi FPS)',
...
VALUES (uid, lmu, 'simulatore', 'ffb',
  'Le Mans Ultimate – FFB Thrustmaster & Fanatec',
...
VALUES (uid, ac, 'simulatore', 'ffb',
  'Assetto Corsa – FFB con Content Manager',
...
VALUES (uid, ac, 'simulatore', 'controlli',
  'Assetto Corsa – Mapping Controlli & Sterzo Ottimale',
...
VALUES (uid, f125, 'simulatore', 'ffb',
  'F1 25 – FFB Ottimizzato per Volante',
...
VALUES (uid, acc, 'simulatore', 'audio',
  'ACC – Audio Ottimizzato per Cuffie',
