        ...
        <CardBody>
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-1">
                {GAMES.map((g) => (
                  ...
                  >
                    ...
                    <input type="checkbox" name="games" value={g.slug} checked={selectedGames.includes(g.slug)} readOnly className="sr-only" />
                  </div>
                ))}
              </div>
            </div>
            ...
            >
              ...
              <input type="checkbox" name="recruiting" checked={recruiting} readOnly className="sr-only" />
            </div>
